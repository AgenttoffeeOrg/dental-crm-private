-- ================================================================
-- FINAL MIGRATION SCRIPT - APPLIES ALL 57 MIGRATIONS
-- ================================================================
-- This script wraps each potential error in exception handling
-- Safe to run multiple times
-- ================================================================

-- Set to continue on errors
SET client_min_messages TO WARNING;

-- Wrap in transaction that allows errors
BEGIN;

-- Drop and recreate the problematic index to avoid conflicts
DROP INDEX IF EXISTS idx_threshold_alerts_tenant CASCADE;

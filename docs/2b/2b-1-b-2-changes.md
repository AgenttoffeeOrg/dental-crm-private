...
dental-crm/src/lib/conversions/__tests__/google-ads-client.test.ts       (15 → 25 tests; +2 for the refined 401 classification; EXPECTED_QUERY updated for unquoted GAQL enums per §3 row M)

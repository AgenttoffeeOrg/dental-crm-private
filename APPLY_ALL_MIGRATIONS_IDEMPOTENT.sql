...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_dashboard_prefs_user_id 
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS analytics_threshold_alerts (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS analytics_saved_views (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS analytics_shared_dashboards (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
  created_by UUID REFERENCES app_users(id),
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS analytics_data_quality_log (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS analytics_anomalies_detected (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
...
-- Create shares table
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.marketing_audit_shares (
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS automation_event_log (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_automation_event_log_tenant ON automation_event_log(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_automation_event_log_type ON automation_event_log(event_type);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_automation_event_log_created ON automation_event_log(created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_automation_event_log_tenant_type ON automation_event_log(tenant_id, event_type);
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS automation_approvals (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS automation_versions (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
    automation_id UUID NOT NULL REFERENCES marketing_journeys(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS automation_rate_limits (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
    automation_id UUID NOT NULL REFERENCES marketing_journeys(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS automation_consent_audit (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
    automation_id UUID NOT NULL REFERENCES marketing_journeys(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS automation_test_runs (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
    automation_id UUID NOT NULL REFERENCES marketing_journeys(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS automations (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS automation_nodes (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS automation_edges (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    automation_id UUID NOT NULL REFERENCES automations(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS automation_runs (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
    automation_id UUID NOT NULL REFERENCES automations(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS automation_execution_logs (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
    automation_id UUID NOT NULL REFERENCES automations(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS deal_sla_rules (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS automation_trigger_metadata (
...
-- Form Versions Table
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.form_versions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.integration_connections (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES public.tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.integration_logs (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES public.tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.integration_rate_limits (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES public.tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.integration_webhooks_log (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES public.tenants(id) ON DELETE CASCADE,
  connection_id UUID REFERENCES public.integration_connections(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.integration_dlq (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES public.tenants(id) ON DELETE CASCADE,
  connection_id UUID REFERENCES public.integration_connections(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS marketing_audit_runs (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS audit_metrics (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS audit_recommendations (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  run_id UUID NOT NULL REFERENCES marketing_audit_runs(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS audit_competitors (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  run_id UUID NOT NULL REFERENCES marketing_audit_runs(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS audit_peer_groups (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  practice_id UUID NOT NULL,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS audit_schedules (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  practice_id UUID NOT NULL,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS audit_alerts (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  run_id UUID NOT NULL REFERENCES marketing_audit_runs(id) ON DELETE CASCADE,
  practice_id UUID NOT NULL,
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_marketing_forms_tenant_id ON public.marketing_forms(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_marketing_forms_status ON public.marketing_forms(status);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_marketing_forms_slug ON public.marketing_forms(public_url_slug) WHERE is_published = TRUE;
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_marketing_forms_created_at ON public.marketing_forms(created_at DESC);

CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_form_submissions_tenant_id ON public.marketing_form_submissions(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_form_submissions_form_id ON public.marketing_form_submissions(form_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_form_submissions_contact_id ON public.marketing_form_submissions(contact_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_form_submissions_is_spam ON public.marketing_form_submissions(is_spam);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_form_submissions_submitted_at ON public.marketing_form_submissions(submitted_at DESC);
...
-- Indexes for performance
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_notifications_user_unread ON notifications(user_id, created_at DESC) WHERE read_at IS NULL AND archived_at IS NULL;
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_notifications_user_created ON notifications(user_id, created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_notifications_tenant ON notifications(tenant_id, created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_notifications_event_id ON notifications(event_id) WHERE event_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_notifications_group_key ON notifications(group_key, created_at DESC) WHERE group_key IS NOT NULL;
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_notifications_entity ON notifications(entity_type, entity_id) WHERE entity_type IS NOT NULL;
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS notification_preferences (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_notification_preferences_user ON notification_preferences(user_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_notification_preferences_tenant ON notification_preferences(tenant_id);
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS notification_policies (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_notification_policies_tenant ON notification_policies(tenant_id);
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS notification_delivery_log (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_delivery_log_notification ON notification_delivery_log(notification_id, channel);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_delivery_log_status ON notification_delivery_log(status, created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_delivery_log_external_id ON notification_delivery_log(external_id) WHERE external_id IS NOT NULL;
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.practice_branding (
  id uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS settings_versions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS settings_approvals (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS stage_auto_move_rules (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS task_escalation_rules (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS task_reminder_settings (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.marketing_audit_webhooks (
  id uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.marketing_audit_webhook_logs (
  id uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS email_logs (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- Indexes for performance
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_email_logs_user_id ON email_logs(user_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_email_logs_tenant_id ON email_logs(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_email_logs_status ON email_logs(status);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_email_logs_email_type ON email_logs(email_type);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_email_logs_created_at ON email_logs(created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_email_logs_to_email ON email_logs(to_email);
...
-- App Users
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_app_users_tenant_id ON app_users(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_app_users_email ON app_users(email);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_app_users_role ON app_users(role);

-- Contacts
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_contacts_tenant_id ON contacts(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_contacts_email ON contacts(email);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_contacts_status ON contacts(status);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_contacts_source ON contacts(source);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_contacts_created_at ON contacts(created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_contacts_full_name_trgm ON contacts USING gin(full_name gin_trgm_ops);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_contacts_company_trgm ON contacts USING gin(company gin_trgm_ops);

-- Enable trigram extension for fuzzy search
CREATE EXTENSION IF NOT EXISTS pg_trgm;

-- Deals
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_tenant_id ON deals(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_pipeline_id ON deals(pipeline_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_stage_id ON deals(stage_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_contact_id ON deals(contact_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_owner_id ON deals(owner_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_status ON deals(status);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_created_at ON deals(created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_updated_at ON deals(updated_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_expected_close_date ON deals(expected_close_date);

-- Pipelines
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_pipelines_tenant_id ON pipelines(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_pipelines_is_active ON pipelines(is_active);

-- Stages
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_stages_pipeline_id ON stages(pipeline_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_stages_order ON stages(display_order);

-- Tasks
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tasks_tenant_id ON tasks(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tasks_assignee_id ON tasks(assignee_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tasks_deal_id ON tasks(deal_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tasks_contact_id ON tasks(contact_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tasks_status ON tasks(status);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tasks_priority ON tasks(priority);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tasks_due_date ON tasks(due_date);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tasks_created_at ON tasks(created_at DESC);

-- Email Templates
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_email_templates_tenant_id ON email_templates(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_email_templates_type ON email_templates(template_type);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_email_templates_is_active ON email_templates(is_active);

-- Campaigns
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_campaigns_tenant_id ON campaigns(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_campaigns_status ON campaigns(status);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_campaigns_created_at ON campaigns(created_at DESC);

-- Forms
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_forms_tenant_id ON forms(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_forms_is_active ON forms(is_active);

-- Form Submissions
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_form_submissions_form_id ON form_submissions(form_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_form_submissions_created_at ON form_submissions(created_at DESC);

-- Audit Logs
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_audit_logs_user_id ON audit_logs(user_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_audit_logs_tenant_id ON audit_logs(tenant_id);
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_tenant_pipeline ON deals(tenant_id, pipeline_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_tenant_status ON deals(tenant_id, status);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_contacts_tenant_status ON contacts(tenant_id, status);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tasks_assignee_status ON tasks(assignee_id, status);
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS user_pipeline_preferences (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES app_users(id) ON DELETE CASCADE,
...
-- Indexes
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_user_pipeline_prefs_user_id ON user_pipeline_preferences(user_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_user_pipeline_prefs_last_selected ON user_pipeline_preferences(last_selected_pipeline_id);
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'contacts') THEN
    CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_contacts_not_deleted ON contacts(tenant_id, deleted_at) WHERE deleted_at IS NULL;
  END IF;
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'deals') THEN
    CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_not_deleted ON deals(tenant_id, deleted_at) WHERE deleted_at IS NULL;
  END IF;
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'tasks') THEN
    CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tasks_not_deleted ON tasks(tenant_id, deleted_at) WHERE deleted_at IS NULL;
  END IF;
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'pipelines') THEN
    CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_pipelines_not_deleted ON pipelines(tenant_id, deleted_at) WHERE deleted_at IS NULL;
  END IF;
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'automations') THEN
    CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_automations_not_deleted ON automations(tenant_id, deleted_at) WHERE deleted_at IS NULL;
  END IF;
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'marketing_campaigns') THEN
    CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_marketing_campaigns_not_deleted ON marketing_campaigns(tenant_id, deleted_at) WHERE deleted_at IS NULL;
  END IF;
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS features (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_features_code ON features(code);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_features_parent ON features(parent_feature_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_features_category ON features(category);
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS tenant_entitlements (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_entitlements_tenant ON tenant_entitlements(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_entitlements_feature ON tenant_entitlements(feature_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_entitlements_enabled ON tenant_entitlements(tenant_id, feature_id) 
...
-- Indexes for performance
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_webhook_events_tenant ON webhook_events(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_webhook_events_source ON webhook_events(source, event_type);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_webhook_events_status ON webhook_events(tenant_id, status);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_webhook_events_received ON webhook_events(received_at DESC);
...
CREATE UNIQUE INDEX IF NOT EXISTS IF NOT EXISTS uq_contacts_email_norm
...
CREATE UNIQUE INDEX IF NOT EXISTS IF NOT EXISTS uq_contacts_phone_e164
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_contacts_is_duplicate ON contacts(tenant_id, is_duplicate) WHERE is_duplicate = true;
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_contacts_merged_into ON contacts(merged_into_id) WHERE merged_into_id IS NOT NULL;
...
CREATE UNIQUE INDEX IF NOT EXISTS IF NOT EXISTS uq_automation_exec_idem
  ON automation_execution_logs(tenant_id, automation_id, idempotency_key)
  WHERE idempotency_key IS NOT NULL;

-- Index for correlation (tracing)
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_automation_correlation 
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS automation_dlq (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
  automation_id UUID NOT NULL REFERENCES automations(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_automation_dlq_tenant ON automation_dlq(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_automation_dlq_automation ON automation_dlq(automation_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_automation_dlq_status ON automation_dlq(tenant_id, status) WHERE status = 'quarantined';
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_automation_dlq_failed ON automation_dlq(failed_at DESC);
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS automation_concurrency_leases (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_concurrency_lease_key ON automation_concurrency_leases(lease_key);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_concurrency_lease_expires ON automation_concurrency_leases(expires_at);
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS erasure_tombstones (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tombstone_tenant ON erasure_tombstones(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tombstone_resource ON erasure_tombstones(resource_type, resource_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tombstone_erased ON erasure_tombstones(erased_at DESC);
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS data_subject_requests (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_dsr_tenant ON data_subject_requests(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_dsr_status ON data_subject_requests(tenant_id, status) WHERE status != 'completed';
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_dsr_due ON data_subject_requests(due_at) WHERE status NOT IN ('completed', 'rejected');
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_dsr_email ON data_subject_requests(requester_email);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_dsr_requested ON data_subject_requests(requested_at DESC);
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS security_alerts (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_security_alerts_tenant ON security_alerts(tenant_id, created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_security_alerts_severity ON security_alerts(severity, created_at DESC) WHERE severity IN ('high', 'critical');
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_security_alerts_unresolved ON security_alerts(created_at DESC) WHERE resolved_at IS NULL;
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_locations_tenant ON locations(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_locations_active ON locations(tenant_id, is_active) WHERE is_active = true;
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS org_memberships (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES app_users(id) ON DELETE CASCADE,
  tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_org_memberships_user ON org_memberships(user_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_org_memberships_tenant ON org_memberships(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_org_memberships_status ON org_memberships(status) WHERE status = 'active';
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_org_memberships_user_active ON org_memberships(user_id, tenant_id) WHERE status = 'active';
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS user_invitations (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE CASCADE,
  email TEXT NOT NULL,
  role TEXT NOT NULL CHECK (role IN ('owner', 'super_admin', 'admin', 'manager', 'staff', 'marketing', 'read_only')),
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_invitations_tenant ON user_invitations(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_invitations_email ON user_invitations(email);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_invitations_token ON user_invitations(invitation_token);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_invitations_status ON user_invitations(status) WHERE status = 'pending';
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS org_access_log (
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_org_access_log_user ON org_access_log(user_id, created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_org_access_log_org ON org_access_log(to_org_id, created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_org_access_log_suspicious ON org_access_log(created_at DESC) WHERE access_type = 'suspicious';

-- =====================================================
-- 10. ISOLATION VIOLATION LOG (Security Monitoring)
-- =====================================================

CREATE TABLE IF NOT EXISTS IF NOT EXISTS isolation_violations (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_isolation_violations_user ON isolation_violations(user_id, created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_isolation_violations_type ON isolation_violations(violation_type, created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_isolation_violations_org ON isolation_violations(attempted_org_id, created_at DESC);
...
-- Contacts
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_contacts_org_created ON contacts(tenant_id, created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_contacts_org_updated ON contacts(tenant_id, updated_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_contacts_org_location ON contacts(tenant_id, location_id) WHERE location_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_contacts_org_owner ON contacts(tenant_id, owner_user_id) WHERE owner_user_id IS NOT NULL;

-- Deals
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_org_created ON deals(tenant_id, created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_org_updated ON deals(tenant_id, updated_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_org_pipeline ON deals(tenant_id, pipeline_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_org_stage ON deals(tenant_id, stage_id) WHERE stage_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_org_contact ON deals(tenant_id, contact_id) WHERE contact_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_org_location ON deals(tenant_id, location_id) WHERE location_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_deals_org_owner ON deals(tenant_id, owner_user_id) WHERE owner_user_id IS NOT NULL;

-- Pipelines
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_pipelines_org_created ON pipelines(tenant_id, created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_pipelines_org_active ON pipelines(tenant_id) WHERE active = true;

-- Pipeline Stages
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_stages_org_pipeline ON pipeline_stages(tenant_id, pipeline_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_stages_pipeline_position ON pipeline_stages(pipeline_id, position);

-- Tasks
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tasks_org_created ON tasks(tenant_id, created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tasks_org_due ON tasks(tenant_id, due_at) WHERE due_at IS NOT NULL;
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tasks_org_status ON tasks(tenant_id, status);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tasks_org_contact ON tasks(tenant_id, contact_id) WHERE contact_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tasks_org_deal ON tasks(tenant_id, deal_id) WHERE deal_id IS NOT NULL;

-- Activities
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_activities_org_occurred ON activities(tenant_id, occurred_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_activities_org_contact ON activities(tenant_id, contact_id) WHERE contact_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_activities_org_deal ON activities(tenant_id, deal_id) WHERE deal_id IS NOT NULL;
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS data_reconciliation_log (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_reconciliation_batch ON data_reconciliation_log(migration_batch);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_reconciliation_table ON data_reconciliation_log(table_name, action);

-- Quarantine for records we can't auto-fix
CREATE TABLE IF NOT EXISTS IF NOT EXISTS data_quarantine (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  table_name TEXT NOT NULL,
  record_id UUID NOT NULL,
  issue TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_quarantine_needs_review ON data_quarantine(created_at) WHERE requires_manual_review = true;
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_permissions_module ON permissions(module);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_permissions_code ON permissions(code);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_permissions_dangerous ON permissions(is_dangerous) WHERE is_dangerous = true;

-- =====================================================
-- 2. ROLE DEFINITIONS TABLE
-- =====================================================

CREATE TABLE IF NOT EXISTS IF NOT EXISTS role_definitions (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_role_definitions_code ON role_definitions(code);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_role_definitions_tenant ON role_definitions(tenant_id) WHERE tenant_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_role_definitions_custom ON role_definitions(is_custom_role) WHERE is_custom_role = true;
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_role_permissions_role ON role_permissions(role_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_role_permissions_permission ON role_permissions(permission_id);
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_user_permissions_user ON user_permissions(user_id, tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_user_permissions_permission ON user_permissions(permission_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_user_permissions_active ON user_permissions(user_id, tenant_id) WHERE granted = true AND (expires_at IS NULL OR expires_at > NOW());
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS permission_changes_log (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_perm_changes_tenant ON permission_changes_log(tenant_id, created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_perm_changes_user ON permission_changes_log(target_user_id, created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_perm_changes_type ON permission_changes_log(change_type, created_at DESC);
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS data_access_log (
  id BIGSERIAL PRIMARY KEY,
  tenant_id UUID NOT NULL REFERENCES tenants(id),
  user_id UUID NOT NULL REFERENCES app_users(id),
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_data_access_tenant ON data_access_log(tenant_id, created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_data_access_user ON data_access_log(user_id, created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_data_access_table_record ON data_access_log(accessed_table, accessed_record_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_data_access_sensitive ON data_access_log(created_at DESC) WHERE accessed_table IN ('contacts', 'deals', 'billing');
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_consent_contact ON consent_records(contact_id, consent_type);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_consent_tenant ON consent_records(tenant_id, created_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_consent_active ON consent_records(contact_id, consent_type) WHERE granted = true AND withdrawn_at IS NULL;

-- =====================================================
-- 4. GDPR DATA EXPORT REQUESTS
-- =====================================================

CREATE TABLE IF NOT EXISTS IF NOT EXISTS gdpr_export_requests (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES tenants(id),
  requested_by_user_id UUID NOT NULL REFERENCES app_users(id),
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_gdpr_exports_tenant ON gdpr_export_requests(tenant_id, requested_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_gdpr_exports_user ON gdpr_export_requests(requested_by_user_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_gdpr_exports_status ON gdpr_export_requests(status, requested_at DESC) WHERE status IN ('pending', 'processing');

-- =====================================================
-- 5. GDPR DATA DELETION REQUESTS
-- =====================================================

CREATE TABLE IF NOT EXISTS IF NOT EXISTS gdpr_deletion_requests (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES tenants(id),
  requested_by_user_id UUID NOT NULL REFERENCES app_users(id),
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_gdpr_deletions_tenant ON gdpr_deletion_requests(tenant_id, requested_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_gdpr_deletions_status ON gdpr_deletion_requests(status, requested_at DESC) WHERE status IN ('pending', 'approved', 'processing');
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_retention_policies_tenant ON data_retention_policies(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_retention_policies_enabled ON data_retention_policies(tenant_id) WHERE enabled = true;

-- =====================================================
-- 7. PRIVACY SETTINGS PER TENANT
-- =====================================================

CREATE TABLE IF NOT EXISTS IF NOT EXISTS privacy_settings (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL UNIQUE REFERENCES tenants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS security_breaches (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL REFERENCES tenants(id),
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_breaches_tenant ON security_breaches(tenant_id, detected_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_breaches_status ON security_breaches(status, detected_at DESC) WHERE status IN ('open', 'investigating');
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_breaches_severity ON security_breaches(severity, detected_at DESC) WHERE severity IN ('high', 'critical');
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tenants_website_host 
  ON tenants(website_host) 
  WHERE website_host IS NOT NULL;

-- Index for subdomain routing
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tenants_subdomain 
  ON tenants(subdomain) 
  WHERE subdomain IS NOT NULL;

-- Index for custom domain routing
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tenants_custom_domain 
  ON tenants(custom_domain) 
  WHERE custom_domain IS NOT NULL;

-- Index for multi-location lookups
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tenants_dental_group 
  ON tenants(dental_group_id) 
  WHERE dental_group_id IS NOT NULL;

-- Index for verification status
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tenants_verified 
  ON tenants(verified_at) 
  WHERE verified_at IS NOT NULL;

-- Composite index for common query pattern
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tenants_is_multi_location 
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS tenant_admins (
  -- Primary key
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tenant_admins_tenant 
  ON tenant_admins(tenant_id);

CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tenant_admins_user 
  ON tenant_admins(user_id);

CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_tenant_admins_active 
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS dental_groups (
  -- Primary key
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_dental_groups_website_host 
  ON dental_groups(website_host) 
  WHERE website_host IS NOT NULL;

-- Index for creator lookup
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_dental_groups_created_by 
  ON dental_groups(created_by_user_id);

-- Index for active groups
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_dental_groups_active 
  ON dental_groups(is_active) 
  WHERE is_active = TRUE;

-- Full text search on name
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_dental_groups_name_search 
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS user_location_access (
  -- Primary key
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_user_location_access_user_active 
  ON user_location_access(user_id, is_active) 
  WHERE is_active = TRUE;

-- Reverse lookup: "Which users have access to location Y?"
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_user_location_access_tenant_active 
  ON user_location_access(tenant_id, is_active) 
  WHERE is_active = TRUE;

-- Composite index for RLS helper function
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_user_location_access_lookup 
  ON user_location_access(user_id, tenant_id, is_active);

-- Admin query: "Who granted access?"
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_user_location_access_granted_by 
  ON user_location_access(granted_by_user_id);

-- Audit query: "Recently revoked access"
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_user_location_access_revoked 
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS organization_join_requests (
  -- Primary key
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_join_requests_tenant_status 
  ON organization_join_requests(tenant_id, status) 
  WHERE status = 'pending';

-- Find user's requests
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_join_requests_user 
  ON organization_join_requests(requester_user_id);

-- Find requests by email (for linking after signup)
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_join_requests_email 
  ON organization_join_requests(requester_email);

-- Admin dashboard: recent requests
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_join_requests_created 
  ON organization_join_requests(tenant_id, created_at DESC);

-- Audit: who decided
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_join_requests_decided_by 
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS plans (
  -- Primary key
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS plan_entitlements (
  -- Primary key
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS subscriptions (
  -- Primary key
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS usage_events (
  -- Primary key
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- CREATE TABLE IF NOT EXISTS usage_events_y2025m01 PARTITION OF usage_events
...
-- Plans
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_plans_tier ON plans(tier) WHERE is_active = TRUE;
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_plans_featured ON plans(is_featured) WHERE is_featured = TRUE;
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_plans_stripe_product ON plans(stripe_product_id);

-- Plan entitlements
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_plan_entitlements_plan ON plan_entitlements(plan_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_plan_entitlements_key ON plan_entitlements(key);

-- Subscriptions
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_subscriptions_tenant ON subscriptions(tenant_id) WHERE tenant_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_subscriptions_group ON subscriptions(dental_group_id) WHERE dental_group_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_subscriptions_status ON subscriptions(status);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_subscriptions_stripe ON subscriptions(stripe_subscription_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_subscriptions_period_end ON subscriptions(current_period_end);

-- Invoices
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_invoices_tenant ON invoices(tenant_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_invoices_group ON invoices(dental_group_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_invoices_subscription ON invoices(subscription_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_invoices_stripe ON invoices(stripe_invoice_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_invoices_status ON invoices(status);

-- Usage events
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_usage_events_tenant ON usage_events(tenant_id, occurred_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_usage_events_key ON usage_events(key, occurred_at DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_usage_events_unbilled ON usage_events(billed_in_invoice_id) 

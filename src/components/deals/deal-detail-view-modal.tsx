...
export function DealDetailView({ dealId, onClose, onContactClick }: DealDetailViewProps) {
  ...
  const [editField, setEditField] = useState<
    'value' | 'stage' | 'tags' | 'source' | 'description' | 'title' | null
  >(null);
    ...
    try {
      ...
      switch (editField) {
        ...
        case 'stage':
          ...
          break;
        case 'tags':
          updateData.treatment_tags = editValue
            .split(',')
            .map((t: string) => t.trim())
            .filter(Boolean);
          break;
  ...
  const lastActivityLabel = useMemo(() => {
    const candidate =
      deal?.last_activity_at || activities?.[0]?.occurred_at || deal?.updated_at || null;
      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col flex-shrink-0">
        ...
        <div className="p-6 border-b border-gray-200">
          <Button
            ...
            size="sm"
            onClick={onClose}
            className="hover:bg-gray-100 -ml-2 mb-2"
          >
            <ArrowLeft className="h-4 w-4 mr-2" />
            Back
          </Button>
          ...
          <div className="border-b border-gray-200 bg-white px-6 py-5 space-y-4">
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <Button size="sm" variant="outline" onClick={() => setAiAssistantOpen(true)}>
                  <Bot className="h-4 w-4 mr-2" />
                  AI Assist
                </Button>
                <Button size="sm" variant="ghost" onClick={() => setCreateActivityDialogOpen(true)}>
              ...
              <div className="rounded-2xl border border-gray-200 bg-gray-50 overflow-hidden">
                <div className="max-h-full overflow-y-auto">
                  <div className="px-6 py-6 space-y-6">
                    ...
                    {deal.treatment_tags &&
                      Array.isArray(deal.treatment_tags) &&
          ...
          <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
            <DialogContent className="sm:max-w-[500px]">
              <DialogHeader>
                ...
                <DialogDescription>Make changes to your deal information</DialogDescription>
              </DialogHeader>
        ...
        {aiAssistantOpen && (
          <>
            ...
            <div className="fixed inset-y-0 right-0 w-96 bg-white border-l border-gray-200 shadow-2xl z-[70] flex flex-col">
              ...
              {/* AI Chat Content */}
              <div className="flex-1 overflow-hidden">
                <AIAssistantChat context="deal" contextId={dealId} />
              </div>
            </div>
          </>
        )}

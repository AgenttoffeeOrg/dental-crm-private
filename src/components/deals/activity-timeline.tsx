      ...
      <div className="flex justify-between items-center">
        <div>
          <h3 className="text-base font-medium text-gray-900">
            {showAllContactActivities || !dealId ? 'All Contact Activities' : 'Recent Activity'}
          </h3>
        </div>
              ...
              >
                ...
                <div className="px-3 py-2 flex items-center justify-between">
                  <div className="flex items-center gap-2 flex-1 min-w-0">
                    <div
                      className={`flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center ${getActivityColor(activity.type)} bg-opacity-10`}
                    >
                    ...
                    {isEditing ? (
                      <>
                        <Button
                          size="sm"
                          variant="ghost"
                          onClick={() => saveActivityEdit(activity.id)}
                ...
                <div className="px-3 py-2 border-t border-gray-50">
                  ...
                  {!isEditing &&
                    ...
                    activity.activity_files.length > 0 && (
                      <div className="mt-2">
                        {activity.activity_files
                          .filter((af) => af.files.kind === 'audio')
                          .map((audioFile) => (
                            <div
                              key={audioFile.file_id}
                  ...
                  {!isEditing &&
                    activity.type === 'call' &&
                    (!activity.activity_files ||
                      activity.activity_files.filter((af) => af.files.kind === 'audio').length ===
                        0) && (
                      <div className="mt-2">

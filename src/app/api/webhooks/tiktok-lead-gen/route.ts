  ...
  try {
    ...
    if (appSecret && signature) {
      ...
      if (signature !== expectedSignature) {
        console.error('[TikTok Webhook] Invalid signature', { correlation_id: correlationId, request_id: requestId })
    ...
    console.error('[TikTok Webhook] Error:', error, { correlation_id: correlationId, request_id: requestId })
    return NextResponse.json(

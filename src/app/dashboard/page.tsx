...
export default function DashboardRedesigned() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const revenueLastMonth = dealsLastMonth.reduce(
        (sum, d) => sum + (d.value_estimate_cents || 0),
        0
      );
        ...
        <div className="h-full overflow-y-auto bg-gray-50">
          <div className="max-w-2xl mx-auto px-4 py-12">
            <div className="text-center">
              ...
              <h1 className="text-2xl font-bold text-gray-900 mb-2">Welcome to Dental CRM! 👋</h1>
              <p className="text-gray-600 mb-6">
                Get started by creating your organization. This will let you manage contacts, deals,
                and more.
              </p>
              <Button
                onClick={() => {
          ...
          <div className="grid auto-rows-fr grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            >
              <CardContent className="flex h-full flex-col justify-between p-5">
                ...
                <p className="mt-4 text-xs text-gray-500">
                  Pipeline momentum across all open deals
                </p>
              </CardContent>
            </Card>
            ...
            >
              <CardContent className="flex h-full flex-col justify-between p-5">
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1">
                    ...
                    {stats.activeTasks > 10 && (
                      <Badge
                        variant="secondary"
                        className="mt-2 w-fit bg-orange-100 text-xs font-semibold text-orange-700"
                      >
                        High
                      </Badge>
                    )}
                ...
                <p className="mt-4 text-xs text-gray-500">
                  Stay on top of follow-ups and reminders
                </p>
              </CardContent>
            </Card>
          </div>
